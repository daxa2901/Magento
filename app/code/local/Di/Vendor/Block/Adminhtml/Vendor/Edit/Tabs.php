<?php
class di_Vendor_Block_Adminhtml_Vendor_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs {
	...
	protected function _beforeToHtml() {
		$vendorAttributes = Mage::getResourceModel('eav/entity_attribute_collection')->setEntityTypeFilter(Mage::getModel('eav/entity')->setType(Di_Vendor_Model_Resource_Vendor::ENTITY)->getTypeId());
