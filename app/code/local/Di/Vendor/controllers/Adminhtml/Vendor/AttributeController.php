...
class Di_Vendor_Adminhtml_Vendor_AttributeController extends Mage_Adminhtml_Controller_Action
{
	...
	public function preDispatch() {
		parent::preDispatch();
		$this->_entityTypeId = Mage::getModel('eav/entity')->setType(Di_Vendor_Model_Resource_Vendor::ENTITY)->getTypeId();
	}
	...
	protected function _filterPostData($data) {
		if ($data) {
			...
			if (!empty($data['option']) && !empty($data['option']['value']) && is_array($data['option']['value'])) {
				...
				? sprintf('<%s>', imDiode('><', $this->_getAllowedTags())) : null;
